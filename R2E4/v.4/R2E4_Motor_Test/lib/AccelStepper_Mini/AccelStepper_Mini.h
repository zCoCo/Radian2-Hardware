...
/////////////////////////////////////////////////////////////////////
/// \class AccelStepper_Mini AccelStepper_Mini.h <AccelStepper_Mini.h>
...
public:
    ...
    /// AccelStepper_Mini::DRIVER (1) means a stepper driver (with Step and Direction pins).
    /// If an enable line is also needed, call setEnablePin() after construction.
    /// You may also invert the pins using setPinsInverted().
    /// AccelStepper_Mini::FULL2WIRE (2) means a 2 wire stepper (2 pins required).
    /// AccelStepper_Mini::FULL3WIRE (3) means a 3 wire stepper, such as HDD spindle (3 pins required).
    /// AccelStepper_Mini::FULL4WIRE (4) means a 4 wire stepper (4 pins required).
    /// AccelStepper_Mini::HALF3WIRE (6) means a 3 wire half stepper, such as HDD spindle (3 pins required)
    /// AccelStepper_Mini::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
    /// Defaults to AccelStepper_Mini::FULL4WIRE (4) pins.
    /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
    /// to pin 2. For a AccelStepper_Mini::DRIVER (interface==1),
    /// this is the Step input to the driver. Low to high transition means to step)
    /// \param[in] pin2 Arduino digital pin number for motor pin 2. Defaults
    /// to pin 3. For a AccelStepper_Mini::DRIVER (interface==1),
    ...
    AccelStepper_Mini(uint8_t pin1 = 2, uint8_t pin2 = 3, bool enable = true);
...
private:
    ...
    /// The target position in steps. The AccelStepper_Mini library will move the
...
/// Shows how to run AccelStepper_Mini in the simplest,
...
/// Shows how to use AccelStepper_Mini to control a 3-phase motor, such as a HDD spindle motor
/// using the Adafruit Motor Shield http://www.ladyada.net/make/mshield/index.html.

/// @example DualMotorShield.pde
/// Shows how to use AccelStepper_Mini to control 2 x 2 phase steppers using the
